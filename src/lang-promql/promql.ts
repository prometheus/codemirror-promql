...
export const promQLSyntax = new LezerSyntax(parser.withProps(
  styleTags({
    ...
    "avg bottomk count count_values max min quantile stddev stdvar sum topk": "keyword definition",
    "group_left group_right by without bool offset on and or unless": "operator",
    BinOp: "operator",
    MatchOp: "operator",
    UnaryOp: "operator",
    "( )": "paren",
